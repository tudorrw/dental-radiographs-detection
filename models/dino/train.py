...
from utils.utils import ModelEma, BestMetricHolder
...
def get_args_parser():
    ...
    parser.add_argument("--pretrain_model_path", default="checkpoints/dino/pretrained/checkpoint0033_4scale.pth", help="load from other checkpoint")
